...
typedef struct MappedObject_t
{
    ...
    uintptr_t               m_iLoadBase;                           // Offest at which first segment ( smallest virtual address ) is loaded at.
...
/* Free all memory thats ever allocated by "MappedObject_Initialize" */
